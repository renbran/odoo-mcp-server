...
export class OdooTools {
    ...
    async handleSearch(client, args) {
    ...
    async handleSearchRead(client, args) {
    ...
    async handleCreate(client, args) {
    ...
    async handleUpdate(client, args) {
    ...
    async handleDelete(client, args) {
    ...
    async handleExecute(client, args) {
    ...
    async handleWorkflowAction(client, args) {
    ...
    async handleGenerateReport(client, args) {
    ...
    async handleGetModelMetadata(client, args) {
