...
export class RadialChart extends Component {
  static template = "synconics_bi_dashboard.RadialChart";
  static props = {
    chartId: String,
    name: String,
  ...
  async render_radial_chart() {
    ...
    this.root = window.am5_index.Root.new("radial_chart__" + this.props.chartId);
    ...
    var cursor = chart.set(
      "cursor",
      window.am5_radar.RadarCursor.new(this.root, {
        behavior: "zoomX",
      }),
    );
