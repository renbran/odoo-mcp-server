...
export class StackedColumnChart extends Component {
  ...
  async render_stacked_column_chart() {
    ...
    this.root = window.am5_index.Root.new("stacked_column_chart__" + this.props.chartId);
    ...
    chart.set(
      "scrollbarX",
      window.am5_index.Scrollbar.new(this.root, {
    ...
    function makeSeries(name, fieldName) {
      ...
      series.columns.template.setAll({
        ...
        tooltipY: window.am5_index.percent(10),
      });
